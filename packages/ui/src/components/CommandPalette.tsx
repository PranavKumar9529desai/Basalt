    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-start justify-center pt-[15vh] px-4 pointer-events-none">
            ...
            <div className="w-full max-w-xl bg-slate-900 border border-slate-700 shadow-2xl rounded-xl overflow-hidden flex flex-col pointer-events-auto transform transition-all duration-200 scale-100">
                ...
                <div className="max-h-[50vh] overflow-y-auto py-2 custom-scrollbar" role="listbox">
        ...
        return (
            ...
            >
                ...
                >
                    {cmd.icon ? (
                        <span className="flex items-center justify-center">
                            {typeof cmd.icon === "bigint" ? String(cmd.icon) : (cmd.icon as React.ReactNode)}
                        </span>
                    ) : (
                ...
                <div className="flex-1 min-w-0">
                    ...
                    {cmd.category && (
                        <div
                            className={`text-[10px] font-bold uppercase tracking-tight ${isSelected ? "text-indigo-100/70" : "text-slate-500"
                                }`}
                        >
                            {cmd.category}
                        </div>
