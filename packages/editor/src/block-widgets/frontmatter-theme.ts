...
// ---------------------------------------------------------------------------
// Frontmatter Properties panel theme — `--sat-*` tokens only.
//
// Split out of frontmatter-block.ts, mirroring the per-widget theme modules
// (table-theme.ts, math-theme.ts, mermaid-theme.ts).
// ---------------------------------------------------------------------------
