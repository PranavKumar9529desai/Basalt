// ---------------------------------------------------------------------------
// Callout data tables — type aliases, icons, and color tokens.
//
// Split out of callouts.ts: the presentation logic (widget, handler, theme)
// stays there; this module owns the static lookup tables.
// ---------------------------------------------------------------------------
