...
| **FPS at 5,000 Notes** | $\approx 25 - 40\text{ FPS}$ (Noticeable stutter) | $\mathbf{60\text{ FPS}}$ *(Rock solid)* | $\mathbf{60 - 120\text{ FPS}}$ |
| **FPS at 25,000 Notes** | $\mathbf{\approx 5 - 12\text{ FPS}}$ *(Freezes / unusable)* | $\mathbf{\ge 60\text{ FPS}}$ *(Within 16.6ms budget)* | $\mathbf{\ge 60\text{ FPS}}$ *(Sub-8ms step budget)* |
